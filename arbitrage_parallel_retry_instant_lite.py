        ...
        def scan_opportunities(
            ...
            if opinion_yes_book and opinion_yes_book.asks and poly_no_book and poly_no_book.asks:
                ...
                if op_yes_ask and pm_no_ask and op_yes_ask.price is not None and pm_no_ask.price is not None:
                    cost = self._round_price(op_yes_ask.price + pm_no_ask.price)
                    ...
                    if cost is not None and cost < THRESHOLD_PRICE and min_size > THRESHOLD_SIZE:
                        ...
                        print(f"  ✓ 发现立即套利: Opinion YES ask + Poly NO ask, 成本=${cost:.3f}, 利润率={profit_rate:.2f}%")
            ...
            if opinion_yes_book and opinion_yes_book.bids and poly_no_book and poly_no_book.asks:
                ...
                if pair:
                    ...
                    cost = self._round_price(op_yes_bid.price + pm_no_ask.price)
                    if cost is not None:
                        ...
                        print(f"  ✓ 发现潜在套利: Opinion YES bid → Poly NO ask, 成本=${cost:.3f}, 利润率={profit_rate:.2f}%")
            ...
            if opinion_no_book and opinion_no_book.asks and poly_yes_book and poly_yes_book.asks:
                ...
                if op_no_ask and pm_yes_ask and op_no_ask.price is not None and pm_yes_ask.price is not None:
                    cost = self._round_price(op_no_ask.price + pm_yes_ask.price)
                    ...
                    if cost is not None and cost < THRESHOLD_PRICE and min_size > THRESHOLD_SIZE:
                        ...
                        print(f"  ✓ 发现立即套利: Opinion NO ask + Poly YES ask, 成本=${cost:.3f}, 利润率={profit_rate:.2f}%")
            ...
            if opinion_no_book and opinion_no_book.bids and poly_yes_book and poly_yes_book.asks:
                ...
                if pair:
                    ...
                    cost = self._round_price(op_no_bid.price + pm_yes_ask.price)
                    if cost is not None:
                        ...
                        print(f"  ✓ 发现潜在套利: Opinion NO bid → Poly YES ask, 成本=${cost:.3f}, 利润率={profit_rate:.2f}%")
            ...
            if poly_yes_book and poly_yes_book.bids and opinion_no_book and opinion_no_book.asks:
                ...
                if pair:
                    ...
                    cost = self._round_price(pm_yes_bid.price + op_no_ask.price)
                    if cost is not None:
                        ...
                        print(f"  ✓ 发现潜在套利: Poly YES bid → Opinion NO ask, 成本=${cost:.3f}, 利润率={profit_rate:.2f}%")
            ...
            if poly_no_book and poly_no_book.bids and opinion_yes_book and opinion_yes_book.asks:
                ...
                if pair:
                    ...
                    cost = self._round_price(pm_no_bid.price + op_yes_ask.price)
                    if cost is not None:
                        ...
                        print(f"  ✓ 发现潜在套利: Poly NO bid → Opinion YES ask, 成本=${cost:.3f}, 利润率={profit_rate:.2f}%")
